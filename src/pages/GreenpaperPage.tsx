...
function GreenpaperPage() {
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h1 className="text-5xl font-bold mb-6">Greenpaper</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-xl p-8 mb-12">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold">Malama Labs Technical Greenpaper</h2>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-gray-300 mb-6">
                This greenpaper presents a comprehensive analysis of Malama Labs' biochar-based carbon removal solution, including our proprietary pyrolysis process, verification methodology, and market dynamics.
              </p>
